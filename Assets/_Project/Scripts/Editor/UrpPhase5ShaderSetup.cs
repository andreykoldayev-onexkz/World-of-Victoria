...
public static class UrpPhase5ShaderSetup
{
    ...
    private static Material CreateOrUpdateChunkMaterial(string assetPath, Shader shader, VoxelPbrTextureLibrary library, float shadowBoost)
    {
        ...
        material.SetColor("_BaseTint", new Color(1.06f, 1.05f, 1.0f, 1f));
        material.SetFloat("_NormalScale", 1f);
        material.SetFloat("_Metallic", 0.03f);
        material.SetFloat("_AlbedoContrast", 1.22f);
        material.SetFloat("_VertexLightBlend", 1f);
        material.SetFloat("_AoStrength", 0.08f);
        material.SetFloat("_LightVolumeStrength", 0f);
        material.SetFloat("_UseVertexBrightness", 1f);
        material.SetFloat("_BrightnessFloor", 0f);
        material.SetFloat("_BrightnessBlackPoint", 0.05f);
        material.SetFloat("_BrightnessWhitePoint", 0.97f);
        material.SetFloat("_BrightnessGamma", 1.24f);
        material.SetFloat("_ProbeGiStrength", shadowBoost > 0.01f ? 0.12f : 0.14f);
        material.SetFloat("_ShadowBoost", shadowBoost > 0.01f ? 0.12f : 0.10f);
        material.SetFloat("_RoughnessBias", shadowBoost > 0.01f ? -0.02f : -0.04f);
